...
class dilmap extends StatefulWidget {
  const dilmap({Key? key}) : super(key: key);
  @override
  _dilmap createState() => _dilmap();
}

class _dilmap extends State<dilmap> with WidgetsBindingObserver {
  @override
