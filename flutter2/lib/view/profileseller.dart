...
class _profilesellerState extends State<profileseller> {
 ...
 var jsonString;
   ...
   void getinfo() async {
jsonString=await fetch1.getinfo2();
// json=await fetch1.getinfo2();
final prefs = await SharedPreferences.getInstance();
String email= prefs.get("emailemail").toString();
if(jsonString !=null){
namejaw=jsonString.elementAt(0)['sellername'];
passjaw=jsonString.elementAt(0)['sellerpass'];
emailjaw=jsonString.elementAt(0)['selleremail'];
placejaw=jsonString.elementAt(0)['sellerplace'];
phonejaw=jsonString.elementAt(0)['sellerphone'].toString();
cardjaw=jsonString.elementAt(0)['sellercard'].toString();
superjaw=jsonString.elementAt(0)['suparmarketname'];
print(namejaw);}
// else {
