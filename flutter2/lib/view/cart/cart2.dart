...
class _cart2State extends State<cart2> {
  ...
  void getPostsData() async {
    ...
    List<Product1> A = [];
    if (myList.isEmpty) myList = await fetch.cart();
    // future: wish(myList);
    myList.forEach((post) {
  ...
  void delete(int id) async {
    ...
    if (res != null) {
      Fluttertoast.showToast(
          msg: "delete item done refrch to sure",
  ...
  void book(int id) async {
    ...
    if (res != null) {
      Fluttertoast.showToast(
          msg: "book item done ", textColor: globalcolors.besiccolor);
    }
    getlistitem();
    getPostsData();
  }
  ...
  void buy(int id) async {
    ...
    if (res != null) {
      Fluttertoast.showToast(
          msg: "ordered done", textColor: globalcolors.besiccolor);
    }
    getlistitem();
    getPostsData();
  }
